...
impl DeploymentInventoryService {
    ...
    pub async fn generate_or_retrieve_inventory(
        ...
        let client_vms = if !client_inventories.is_empty() && environment_details.deployment_type != DeploymentType::Bootstrap {
        ...
        let binary_option = if let Some(binary_option) = binary_option {
            ...
            let ant_version = if !client_vms.is_empty() && environment_details.deployment_type != DeploymentType::Bootstrap {
